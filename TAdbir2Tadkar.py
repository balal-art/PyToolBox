...
try:
    ...
    column_mapping = {
        'ردیف': ['ردیف'],
        'ردیف فهرست بها': ['شماره فهرست', 'شماره فهرست بها', 'کد ردیف', 'ردیف فهرست'],
        'مقدار': ['مقدار'],
        'کارکرد /پای کار': ['نوع ردیف', 'نوع ردیف', 'کارکرد'],
        'ف ج *': ['نوع قيمت', 'نوع قیمت', 'نوع'],
        'بهای واحد برآورد': ['بهای واحد برآورد (پایه)', 'بهای واحد برآورد', 'بهای واحد فهرست بها', 'بهای واحد'],
        'بهای واحد پیشنهاد': ['بهای واحد پیشنهاد'],
        'ضریب برآورد': ['ضریب خاص برآورد', 'ضریب برآورد', 'ضریب'],
        'بخش': ['بخش( فعالیت)', 'بخش'],
        'ملاحظات': ['ملاحظات', 'توضیحات'],
        'واحد': ['واحد'],
        'شرح ردیف': ['شرح ردیف','شرح'],
    }
    ...
    # --- ایجاد دیتابیس دوم برای ردیف‌های ستاره دار
    if 'ف ج *' in df_dest.columns:
        # ایجاد شرط برای ردیف‌های * یا ج
        mask = df_dest['ف ج *'].isin(['*'])
